...
i would love to help you to improve the ---WORKS AND PUBLICATIONS,RESEARCHAREAS OF PROFESSOR (write this line only if the technology is provided in the prompt )  
...
thanking you 
---NAMEOFTHEPROFESSOR 
also refrain from using words like this inteerests me , i am paassionate  , etc . he doesnt care about that .
" ; 
